...
class BrowserBackend(object):
    ...
    def venice_document(self, document_id):
        query = self.api.VENICE_DOCUMENT(document_id)
    ...
    @lru_cache(maxsize=LRU_CACHE_SIZE)
    def rb_get_moral_foundations_with_p585(self, limit: int = 20, fmt=None):
        """Retrieve nodes and labels for all nodes with labels starting with 'prefix'.
        ...
        query = self.api.RB_GET_MORAL_FOUNDATIONS_WITH_P585(limit)
