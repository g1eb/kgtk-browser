...
class KypherAPIObject(object):
    def __init__(self):
        ...
        self.RB_GET_EMOTIONS_WITH_P585_FOR_NODE = self.kapi.get_query(
            doc="""
        ...
        self.RB_GET_MORAL_FOUNDATIONS_WITH_P585_FOR_NODE = self.kapi.get_query(
            doc="""
